defmodule Pleroma.Repo.Migrations.RemoveThreadVisibility do
  use Ecto.Migration

  def up() do
    alter table(:users) do
      add_if_not_exists(:skip_thread_containment, :boolean, default: false)
    end
  ...
  def down() do
    ...
    create_thread_visibility_statement()
    |> execute()
  end

  # copied 20220509180452_change_thread_visibility_to_be_local_only_aware.exs
  defp create_thread_visibility_statement() do
    """
